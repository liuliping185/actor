...
$(function(){
   $.post(path + "/ActorInterface/index/findBigType.action",{
		...
		if(id!=null){
			  var actionUrl = path + "/ActorInterface/camerateam/getCamerateamById.action?camerateamId=" + id;
			  $.post(actionUrl,{
            ...
            var provience = data.camerateaminfo.provience;
            var city = data.camerateaminfo.city;
            var district = data.camerateaminfo.district;
            ...
            $("#imgUpload").html(imgs);
					  ...
					  $("#camerateamname").val(data.camerateaminfo.camerateamname);
            $("#camerateaminfos").val(data.camerateaminfo.camerateaminfos);
					  $("#price").val(data.camerateaminfo.price);
					  $("#keywords").val(data.camerateaminfo.keywords);
            $("#representativework").val(data.camerateaminfo.representativework);
            $("#teampresentation").val(data.camerateaminfo.teampresentation);
            $("#experience").val(data.camerateaminfo.experience);
					  $("#address").val(data.camerateaminfo.address);

            $("#firstimg").attr("src",data.camerateaminfo.firstimg);
            $("#firstimg_").val(data.camerateaminfo.firstimg);

					  $("#bigtype").val(data.camerateaminfo.bigid);
					  smallid = data.camerateaminfo.smallid;
					  getSmallType(data.camerateaminfo.bigid);

					  //隐藏域字段
					  $("#hi_evaSum").val(data.camerateaminfo.evaSum);
					  $("#hi_goodSum").val(data.camerateaminfo.goodSum);
					  $("#hi_professionalScore").val(data.camerateaminfo.professionalScore);
					  $("#hi_serviceScore").val(data.camerateaminfo.serviceScore);
					  $("#hi_attentionSum").val(data.camerateaminfo.attentionSum);
					  $("#firstimg_").val(data.camerateaminfo.firstimg);
					  $("#hi_scenestatus").val(data.camerateaminfo.scenestatus);
					  $("#hi_memberid").val(data.camerateaminfo.memberid);
					  $("#hi_createtime").val(data.camerateaminfo.createtime);

            if(data.camerateaminfo.unit){
                $("#unitsImg").hide();
                $("#unit").val(data.camerateaminfo.unit);
            }
				  }
			  });
		}
...
function personalRoleManage(){
  ...
  var camerateamname = $("#camerateamname").val();
  var unit = $("#unit").val();
  ...
  if("" === $("#fmimg").val()){
    ...
    $("#tjBtu").html("");
     ...
     if(id!=null){
        actionURL = path + "/ActorInterface/camerateam/camerateamUpdate.action?token=" + localStorage.token + "&role=" + role;
        $("#hi_id").val(id);
        ...
        $("#multipleGraphsList").val(hi_jsonStr);
          ...
          actionURL = path + "/ActorInterface/camerateam/camerateamApply.action?token=" + localStorage.token + "&role=" + role;
     }
