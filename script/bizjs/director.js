...
$(function(){
   $.post(path + "/ActorInterface/index/findBigType.action",{
		...
		if(id!=null){
			  var actionUrl = path + "/ActorInterface/director/getDirectorById.action?directorId=" + id;
			  $.post(actionUrl,{
          ...
          console.log(data);
            ...
            var provience = data.directorinfo.provience;
            var city = data.directorinfo.city;
            var district = data.directorinfo.district;
            ...
            $("#imgUpload").html(imgs);
					  ...
					  $("#directorname").val(data.directorinfo.directorname);
            $("#age").val(data.directorinfo.age);
            $("#experience").val(data.directorinfo.experience);
            $("#workarea").val(data.directorinfo.workarea);
					  $("#price").val(data.directorinfo.price);
            $("#representativework").val(data.directorinfo.representativework);
            $("#directorinfos").val(data.directorinfo.directorinfos);
					  $("#keywords").val(data.directorinfo.keywords);
					  $("#address").val(data.directorinfo.address);

            $("#firstimg").attr("src",data.directorinfo.firstimg);
            $("#firstimg_").val(data.directorinfo.firstimg);

					  $("#bigtype").val(data.directorinfo.bigid);
					  smallid = data.directorinfo.smallid;
					  getSmallType(data.directorinfo.bigid);

					  //隐藏域字段
					  $("#hi_evaSum").val(data.directorinfo.evaSum);
					  $("#hi_goodSum").val(data.directorinfo.goodSum);
					  $("#hi_professionalScore").val(data.directorinfo.professionalScore);
					  $("#hi_serviceScore").val(data.directorinfo.serviceScore);
					  $("#hi_attentionSum").val(data.directorinfo.attentionSum);
					  $("#firstimg_").val(data.directorinfo.firstimg);
					  $("#hi_memberid").val(data.directorinfo.memberid);
					  $("#hi_createtime").val(data.directorinfo.createtime);

            if(data.directorinfo.unit){
                $("#unitsImg").hide();
                $("#unit").val(data.directorinfo.unit);
            }
				  }
			  });
		}
...
function personalRoleManage(){
  ...
  if("" === $("#fmimg").val()){
    ...
    $("#tjBtu").html("");
     ...
     if(id!=null){
        actionURL = path + "/ActorInterface/director/directorUpdate.action?token=" + localStorage.token + "&role=" + role;
        $("#hi_id").val(id);
        ...
        $("#multipleGraphsList").val(hi_jsonStr);
          ...
          actionURL = path + "/ActorInterface/director/directorApply.action?token=" + localStorage.token + "&role=" + role;
     }
