...
function getActorDetail(data){
    $("#membername").html("发布人: " + data.membername);
    if(data.actinfo.price && data.actinfo.unit){
    ...
    infos += "<div style='margin-top: 2%; margin 0 auto;padding-bottom:10px;'>";
    infos += "<span style='padding-left:5px;font-size:12px; color:#20e0b9; display:inline-block;border:1px solid #20e0b9; margin-left:10%; border-radius:5px;'>身高:";
    infos += "<sapn style='font-size:12px;color:#20e0b9;padding-right:5px;'>" + data.actinfo.height + "cm</span>";
    infos += "</span>";

    infos += "<span style='padding-left:5px;font-size:12px; color:#20e0b9; display:inline-block;border:1px solid #20e0b9;  margin-left:7%; border-radius:5px;'>体重:";
    infos += "<span style='font-size:12px;padding-right:5px;'>" + data.actinfo.weight/2 + "kg</span>";
    infos += "</span>";

    infos += "<span style='padding-left:5px;font-size:12px; color:#20e0b9; display:inline-block;border:1px solid #20e0b9; margin-left:7%; border-radius:5px;'>性别:";
    infos += "<span style='font-size:12px;padding-right:5px;'>" + data.actinfo.sex + "</span>";
    infos += "</span>";

    infos += "<span style='margin-top:2%;padding-left:5px;font-size:12px; color:#20e0b9; display:inline-block;border:1px solid #20e0b9; margin-left:10%; border-radius:5px;'>生日:";
    infos += "<span style='font-size:12px;padding-right:5px;'>" + data.actinfo.birthday + "</span>";
    infos += "</span>";

    if(data.actinfo.provience && data.actinfo.city && data.actinfo.district){
        infos += "<span style='margin-top:2%;padding-left:5px;font-size:12px; color:#20e0b9; display:inline-block;border:1px solid #20e0b9; margin-left:7%; border-radius:5px;'>所在地区:";
        infos += "<span style='font-size:12px;padding-right:5px;'>" + data.actinfo.provience + data.actinfo.city + data.actinfo.district + "</span>";
        infos += "</span>";
    }
    ...
    keywords += "<span style='font-size:12px;padding-left:5px;padding-right:5px;'>" + data.actinfo.keywords + "</span>";
    keywords += "</span>";
    keywords += "<div>";
    ...
    workingRange += "<div>";
    workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.actinfo.infos + "</span>";
    workingRange += "</div>";
    ...
    if(data.actinfo.workarea){
        workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.actinfo.workarea + "</span>";
    }else{
    ...
    workingRange += "<div>";
    workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.actinfo.experience + "</span>";
    workingRange += "</div>";
    workingRange += "</div>";
    workingRange += "</div>";
    ...
    var d = new Date(data.actinfo.createtime);
