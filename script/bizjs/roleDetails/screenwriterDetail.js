...
function getScreenwriter(data){
    ...
    infos += "<h4 style='margin-top:3%; margin-left: 5%; color:#7B7B7B;'><span style='margin-top:3%;'>编剧信息</span></h4>";
    infos += "<span style='margin-top: 2%; margin 0 auto; margin-left:5%; font-size:12px;color:#9D9D9D;padding-bottom:5px;'>";
    if(data.screenwriterinfo.provience && data.screenwriterinfo.city && data.screenwriterinfo.district){
        infos += "<span style='margin-top: 2%; margin 0 auto; margin-left:5%; font-size:13px;color:#8E8E8E;'>" + data.screenwriterinfo.provience + data.screenwriterinfo.city + data.screenwriterinfo.district + data.screenwriterinfo.address + "</span>";
    }
    infos += "<span style='margin-top: 2%; margin 0 auto; margin-left:5%; font-size:12px;color:#9D9D9D;padding-bottom:5px;'>" + data.screenwriterinfo.screenwriterinfos + "</span>";
    infos += "</span>";
    ...
    keywords += "<span style='font-size:12px;padding-left:5px;padding-right:5px;'>" + data.screenwriterinfo.keywords + "</span>";
    keywords += "</span>";
    keywords += "<div>";
    ...
    workingRange += "<div>";
    workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.screenwriterinfo.screenwriterinfos + "</span>";
    workingRange += "</div>";

    workingRange += "<h4 style='margin-left:5%; margin-top:0%; color:#7B7B7B;'><span style='margin-top:3%;'>工作范围</span><h4>";
    workingRange += "<div>";
    if(data.screenwriterinfo.workarea){
        workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.screenwriterinfo.workarea + "</span>";
    }else{
    ...
    workingRange += "<div>";
    if(data.screenwriterinfo.experience){
        workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>" + data.screenwriterinfo.experience + "</span>";
    }else{
        workingRange += "<span style='margin-left:10%;font-size:14px;color:#9D9D9D'>暂无</span>";
    }
    ...
    var d = new Date(data.screenwriterinfo.createtime);
    ...
    $('#imgBig').attr('src', data.screenwriterinfo.firstimg);
